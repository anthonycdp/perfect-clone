...
class TestBrowserManagerStart:
    ...
    async def test_start_creates_browser_and_page(self):
    ...
    async def test_start_with_headless_true(self):
...
class TestBrowserManagerNavigate:
    ...
    async def test_navigate_loads_url(self, page):
...
class TestBrowserManagerResizeViewport:
    ...
    async def test_resize_viewport_multiple_times(self, browser):
        """resize_viewport() should work multiple times."""
        await browser.resize_viewport(800, 600)
        assert browser.page.viewport_size["width"] == 800

        await browser.resize_viewport(1024, 768)
        assert browser.page.viewport_size["width"] == 1024

    async def test_resize_viewport_without_page_does_nothing(self):
...
class TestBrowserManagerClose:
    ...
    async def test_close_without_start_does_not_error(self):
